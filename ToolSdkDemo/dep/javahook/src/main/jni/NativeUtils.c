...
//com.gameassist.plugin.nativeutils
 void  Hookinit(JNIEnv *env, jclass clazz, jint sdkVersion) {
    int i;
...
void findAndBackupAndHook(JNIEnv *env, jclass clazz,
     jclass targetClass, jstring methodName,
     jstring methodSig, jboolean isStatic, jobject hook, jobject backup) {
...
void old_findAndBackupAndHook(JNIEnv *env, jclass clazz,
